...
**Architecture:** Keep user requirements out of shared code constants. Shared code should expose generic project asset classification, SKU card candidate scoring, evidence, and executor preflight data. The `E:\WERKE\C-1194` project is only used by an exam script or runtime parameter, never as a product-code default.
...
- Current exam project is `E:\WERKE\C-1194`.
- Reference finished project is `D:\A1 neveralone旗舰店\C-1137`.
...
- Do not hardcode `E:\WERKE\C-1194` or `D:\A1 neveralone旗舰店\C-1137` in shared runtime code.
...
- Create: `scripts/run-sku-card-exam.cjs`
  ...
  - This is where `E:\WERKE\C-1194` can be passed at runtime.
...
```powershell
npm run exam:sku:card -- --project "E:\WERKE\C-1194" --reference "D:\A1 neveralone旗舰店\C-1137" --out "tmp\sku-card-c1194-exam-report.json"
```
