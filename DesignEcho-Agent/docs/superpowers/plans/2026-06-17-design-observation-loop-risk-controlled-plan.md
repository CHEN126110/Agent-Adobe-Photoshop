...
- Create `C:\UXP\2.0\DesignEcho-Agent\src\shared\design-observation-intents.ts`
  - Owns observation intent ids, evidence requirements, and stage decision labels.
- Create `C:\UXP\2.0\DesignEcho-Agent\scripts\smoke-agent-design-observation-protocol.cjs`
  - Verifies the protocol exists, is read-first, and protects against one-shot render/save behavior.
- Modify `C:\UXP\2.0\DesignEcho-Agent\package.json`
  - Adds a smoke script for the observation protocol.
- Modify `C:\UXP\2.0\DesignEcho-Agent\src\renderer\services\agent-runtime\tool-schemas.ts`
...
- Modify `C:\UXP\2.0\DesignEcho-Agent\src\renderer\services\skill-executors\autonomous-agent.executor.ts`
...
- Modify `C:\UXP\2.0\DesignEcho-Agent\src\renderer\services\tool-display-info.ts`
...
**Files:**
- Create: `C:\UXP\2.0\DesignEcho-Agent\src\shared\design-observation-intents.ts`
- Test: `C:\UXP\2.0\DesignEcho-Agent\scripts\smoke-agent-design-observation-protocol.cjs`
- Modify: `C:\UXP\2.0\DesignEcho-Agent\package.json`
...
- Modify: `C:\UXP\2.0\DesignEcho-Agent\src\renderer\services\skill-executors\autonomous-agent.executor.ts`
- Test: `C:\UXP\2.0\DesignEcho-Agent\scripts\smoke-agent-design-observation-protocol.cjs`
- Existing regression: `C:\UXP\2.0\DesignEcho-Agent\scripts\smoke-agent-creative-document-intent.cjs`
...
**Files:**
- Modify: `C:\UXP\2.0\DesignEcho-Agent\src\shared\design-observation-intents.ts`
- Modify: `C:\UXP\2.0\DesignEcho-Agent\src\renderer\services\skill-executors\autonomous-agent.executor.ts`
- Test: `C:\UXP\2.0\DesignEcho-Agent\scripts\smoke-agent-design-observation-protocol.cjs`
