...
assert(
  ...
  'triage should keep design quality claims disabled for diagnostic evidence',
  diagnosticExport.acceptanceTriage
);
assert(
  diagnosticExport.acceptanceTriage.evidenceBoundary === 'diagnostic_evidence_invalid',
  'triage should classify invalid diagnostic evidence boundaries',
  diagnosticExport.acceptanceTriage
);
...
console.log(JSON.stringify({
  ...
  checks: [
    ...
    'diagnostic evidence boundary violations map to verification ownership',
