...
assert(blocked.warnings.includes('fex_benchmark_is_not_business_strategy_evidence'), 'FEX-only warning must survive', blocked);
assert(blocked.warnings.includes('tool_only_panel_feature_is_not_agent_skill_strategy_evidence'), 'panel-only warning must survive', blocked);
