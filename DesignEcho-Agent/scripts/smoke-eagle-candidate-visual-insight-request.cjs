...
assert(readyRequest.requestedEvidence.includes('subject_regions'), 'request should carry subject-region evidence requirement', readyRequest);
assert(readyRequest.requestedEvidence.includes('actual_bounds'), 'request should carry actual bounds requirement', readyRequest);
assert(readyRequest.requestedEvidence.includes('screenshot_qa'), 'request should carry screenshot QA requirement', readyRequest);
