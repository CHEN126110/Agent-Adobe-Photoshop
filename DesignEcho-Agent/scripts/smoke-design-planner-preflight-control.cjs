...
function run() {
  ...
  assertIncludes(helper, 'buildPlannerExecutionPreflightGate', 'design-planner-evidence.ts');
  ...
  console.log(JSON.stringify({
    ...
    checks: [
      ...
      'layout-replication and main-image consume the shared planner preflight gate',
