...
const childUsagePostDeductionPattern = /performanceLedger\.(?:modelCallCount|toolCallCount|visualAnalysisCount|visionCandidateCount)\s*(?:\+=|=)[^;\n]*childAgentUsage/;
...
const detailPageDesignSkill = read('src/renderer/services/skill-executors/detail-page-design.skill.ts');
