...
function buildReport() {
  ...
  const mainImageAgentDraft = {
    ...
    designStandardsHelperAvailable: exists(agentRoot, 'src/shared/main-image-design-standards-evidence.ts'),
    ...
    plannerEvidenceAttached: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/design-planner-evidence.ts',
    ...
    designStandardsNoExecution: fileIncludes(
      agentRoot,
      'src/shared/main-image-design-standards-evidence.ts',
      'mustNotExecutePhotoshop: true'
    ),
  ...
  const projectAssetIndex = {
    ...
    businessVisualEvidenceGateHelperAvailable: exists(agentRoot, 'src/shared/business-skill-visual-evidence-gate.ts'),
    businessVisualEvidenceFeedbackHelperAvailable: exists(agentRoot, 'src/shared/business-skill-visual-evidence-feedback.ts'),
    businessVisualEvidenceGateRendererAvailable: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'buildBusinessVisualEvidenceGateForSkill'
    ),
    businessVisualEvidenceFeedbackRendererAvailable: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'businessVisualEvidenceFeedback'
    ),
    businessVisualEvidenceFeedbackUiAvailable: fileIncludes(
      agentRoot,
      'src/renderer/components/message/parser.ts',
      'buildBusinessVisualEvidenceFeedbackCard'
    ),
    businessVisualEvidenceGateEntrypointWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
      'attachBusinessVisualEvidenceGateToResult'
    ),
    businessVisualEvidenceGateSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-gate'),
    businessVisualEvidenceFeedbackSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-feedback'),
    businessVisualEvidenceFeedbackDesktopSmokeAvailable: hasScript(packageJson, 'smoke:chat-ui:business-visual-feedback'),
    ...
    agentDiagnosticEvidenceHelperAvailable: exists(agentRoot, 'src/shared/agent-diagnostic-evidence.ts'),
    agentDiagnosticEvidenceSmokeAvailable: hasScript(packageJson, 'smoke:agent:diagnostic-evidence'),
    agentAcceptanceDebugCarriesDiagnosticEvidence: fileIncludes(
      agentRoot,
      'src/shared/agent-acceptance-contracts.ts',
      'diagnosticEvidence'
    ),
    agentAcceptanceDiagnosticControlSmokeAvailable: hasScript(packageJson, 'smoke:agent:acceptance-diagnostic-control'),
    agentAcceptanceDiagnosticControlReportAvailable: fileIncludes(
      agentRoot,
      'src/shared/agent-acceptance-contracts.ts',
    ...
    agentAcceptanceBusinessSkillEvidenceSmokeAvailable: hasScript(packageJson, 'smoke:agent:acceptance-business-skill-evidence'),
    agentAcceptanceBusinessSkillEvidenceReportAvailable: fileIncludes(
      agentRoot,
      'src/shared/agent-acceptance-contracts.ts',
      'businessSkillExecutionPlanIntake'
    ),
    agentAcceptanceBusinessSkillEvidenceExportAvailable: fileIncludes(
      agentRoot,
    ...
    livePhotoshopAcceptanceEvidenceIntakeHelperAvailable: exists(agentRoot, 'src/shared/live-photoshop-acceptance-evidence-intake.ts'),
    ...
    livePhotoshopAcceptanceEvidenceIntakeNoQualityClaim: fileIncludes(
      agentRoot,
      'src/shared/live-photoshop-acceptance-evidence-intake.ts',
    ...
    agentAcceptanceEvidenceMatrixHelperAvailable: exists(agentRoot, 'src/shared/agent-acceptance-evidence-matrix.ts'),
    agentAcceptanceEvidenceMatrixSmokeAvailable: hasScript(packageJson, 'smoke:agent:acceptance-evidence-matrix'),
    agentAcceptanceEvidenceMatrixCommandAvailable: hasScript(packageJson, 'maintenance:acceptance-evidence-matrix'),
    agentAcceptanceEvidenceMatrixNoQualityClaim: fileIncludes(
      agentRoot,
      'src/shared/agent-acceptance-evidence-matrix.ts',
    ...
    chatPanelExportsDiagnosticEvidence: fileIncludes(
      agentRoot,
      'src/renderer/components/ChatPanel.tsx',
    ...
    businessSkillExecutionPreflightEntrypointWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
      'attachBusinessSkillExecutionPreflightGateToResult'
    ),
    businessSkillExecutionPreflightResultEvidenceOnly: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'businessSkillExecutionPreflightGate'
    ),
    businessSkillPreflightPlannerEvidenceHelperAvailable: exists(agentRoot, 'src/shared/business-skill-preflight-planner-evidence.ts'),
    businessSkillPreflightPlannerEvidenceSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:preflight-planner-evidence'),
    businessSkillPreflightPlannerEvidenceWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'businessSkillPreflightPlannerEvidence'
    ),
    businessSkillPreflightPlannerEvidenceNoQualityClaim: fileIncludes(
      agentRoot,
      'src/shared/business-skill-preflight-planner-evidence.ts',
      'canClaimDesignQuality: false'
    ),
    businessSkillVisualEvidenceRefreshPlanHelperAvailable: exists(agentRoot, 'src/shared/business-skill-visual-evidence-refresh-plan.ts'),
    businessSkillVisualEvidenceRefreshPlanSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-refresh-plan'),
    businessSkillVisualEvidenceRefreshPlanWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'businessSkillVisualEvidenceRefreshPlan'
    ),
    businessSkillVisualEvidenceRefreshPlanDefaultDisabled: fileIncludes(
      agentRoot,
      'src/shared/business-skill-visual-evidence-refresh-plan.ts',
      'Visual evidence refresh must be explicitly enabled'
    ),
    businessSkillVisualEvidenceRefreshRunnerSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-refresh-runner'),
    businessSkillVisualEvidenceRefreshRunnerWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
      'await runBusinessSkillVisualEvidenceRefreshAfterExecution'
    ),
    businessSkillVisualEvidenceRefreshRunnerPostExecutor: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      '该 runner 只在业务 executor 完成后运行'
    ),
    businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-refresh-runtime'),
    businessSkillVisualEvidenceRefreshRuntimeAutoDetects: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'detectBusinessSkillVisualEvidenceRefreshRuntime'
    ),
    businessSkillVisualEvidencePreExecutionGateHelperAvailable: exists(agentRoot, 'src/shared/business-skill-visual-evidence-pre-execution-gate.ts'),
    businessSkillVisualEvidencePreExecutionGateSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-pre-execution-gate'),
    businessSkillVisualEvidencePreExecutionGateWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
      'buildBusinessSkillVisualEvidencePreExecutionGate'
    ),
    businessSkillVisualEvidencePreExecutionRunnerWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
      'runBusinessSkillVisualEvidenceRefreshBeforeExecution'
    ),
    businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking: fileIncludes(
      agentRoot,
      'src/shared/business-skill-visual-evidence-pre-execution-gate.ts',
      'Default behavior is non-blocking'
    ),
    businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-refresh-executor-wiring'),
    businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint: fileIncludes(
      agentRoot,
      'scripts/smoke-business-skill-visual-evidence-refresh-executor-wiring.cjs',
      "executeSkillWithExecutor('sku-batch'"
    ),
    businessSkillVisualEvidenceControlDecisionHelperAvailable: exists(agentRoot, 'src/shared/business-skill-visual-evidence-control-decision.ts'),
    businessSkillVisualEvidenceControlDecisionSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-control-decision'),
    businessSkillVisualEvidenceControlDecisionWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
      'attachBusinessSkillVisualEvidenceControlDecisionToResult'
    ),
    businessSkillVisualEvidenceControlDecisionNoQualityClaim: fileIncludes(
      agentRoot,
      'src/shared/business-skill-visual-evidence-control-decision.ts',
      'canClaimDesignQuality: false'
    ),
    businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable: fileIncludes(
      agentRoot,
      'src/shared/agent-diagnostic-evidence.ts',
      'businessSkillVisualEvidenceControlDecision'
    ),
    ...
    businessSkillExecutionIntakeWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
    ...
    projectAssetUnderstandingIntakeWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
    ...
    businessSkillImagePlacementVerificationIntakeWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
    ...
    businessSkillExecutionPlanIntakeWired: fileIncludes(
      agentRoot,
      'src/renderer/services/skill-executors/index.ts',
    ...
    businessSkillVisualEvidenceDiagnosticSmokeAvailable: hasScript(packageJson, 'smoke:business-skill:visual-evidence-diagnostic'),
    ...
    plannerEvidenceConsumesAssetIndex: fileIncludes(agentRoot, 'src/renderer/services/skill-executors/design-planner-evidence.ts', 'assetIndex: projectContext?.assetIndex'),
    ...
    planMentionsM0j: fileIncludes(agentRoot, 'project-memory/Plan.md', 'Milestone M0j')
  };
  ...
  const agentPerformancePolicy = {
    ...
    visualSamplingBudgetHelperAvailable: fileIncludes(agentRoot, 'src/shared/agent-performance-policy.ts', 'buildAgentVisualSamplingBudget'),
    projectVisualSamplingUsesBudget: fileIncludes(agentRoot, 'src/shared/project-visual-sampling.ts', 'buildAgentVisualSamplingBudget'),
    ...
    planMentionsPerformance: fileIncludes(agentRoot, 'project-memory/Plan.md', 'Milestone M0k')
  };
  ...
  gates.push(buildGate({
    ...
    status: inferStatus([
      ...
      fileIncludes(agentRoot, 'scripts/smoke-chat-ui-electron-bridge.cjs', 'document operation telemetry rendered as 工具调用 instead of 正在思考')
    ], [
  ...
  gates.push(buildGate({
    ...
    status: inferStatus([
      ...
      projectAssetIndex.businessVisualEvidenceFeedbackHelperAvailable,
      projectAssetIndex.businessVisualEvidenceFeedbackRendererAvailable,
      projectAssetIndex.businessVisualEvidenceFeedbackUiAvailable,
      projectAssetIndex.businessVisualEvidenceFeedbackSmokeAvailable,
      projectAssetIndex.businessVisualEvidenceFeedbackDesktopSmokeAvailable,
      ...
      projectAssetIndex.agentDiagnosticEvidenceHelperAvailable,
      projectAssetIndex.agentDiagnosticEvidenceSmokeAvailable,
      projectAssetIndex.agentAcceptanceDebugCarriesDiagnosticEvidence,
      projectAssetIndex.agentAcceptanceDiagnosticControlSmokeAvailable,
      projectAssetIndex.agentAcceptanceDiagnosticControlReportAvailable,
      ...
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceSmokeAvailable,
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceReportAvailable,
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceExportAvailable,
      ...
      projectAssetIndex.agentAcceptanceEvidenceMatrixHelperAvailable,
      projectAssetIndex.agentAcceptanceEvidenceMatrixSmokeAvailable,
      projectAssetIndex.agentAcceptanceEvidenceMatrixCommandAvailable,
      projectAssetIndex.agentAcceptanceEvidenceMatrixNoQualityClaim,
      ...
      projectAssetIndex.chatPanelExportsDiagnosticEvidence,
      ...
      projectAssetIndex.businessSkillExecutionPreflightResultEvidenceOnly,
      projectAssetIndex.businessSkillPreflightPlannerEvidenceHelperAvailable,
      projectAssetIndex.businessSkillPreflightPlannerEvidenceSmokeAvailable,
      projectAssetIndex.businessSkillPreflightPlannerEvidenceWired,
      projectAssetIndex.businessSkillPreflightPlannerEvidenceNoQualityClaim,
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanHelperAvailable,
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanSmokeAvailable,
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanWired,
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanDefaultDisabled,
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerSmokeAvailable,
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerWired,
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerPostExecutor,
      projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable,
      projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeAutoDetects,
      projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable,
      projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint,
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionHelperAvailable,
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionSmokeAvailable,
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionWired,
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionNoQualityClaim,
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable,
      projectAssetIndex.businessSkillVisualEvidenceDiagnosticSmokeAvailable,
      ...
      projectAssetIndex.planMentionsM0j
    ], [
    ...
    evidence: [
      ...
      projectAssetIndex.businessVisualEvidenceFeedbackHelperAvailable ? 'src/shared/business-skill-visual-evidence-feedback.ts 已提供业务视觉证据反馈契约' : '',
      projectAssetIndex.businessVisualEvidenceFeedbackRendererAvailable ? 'skill executor wrapper 已附加 businessVisualEvidenceFeedback' : '',
      projectAssetIndex.businessVisualEvidenceFeedbackUiAvailable ? 'Chat message parser 已把 businessVisualEvidenceFeedback 渲染为业务预检卡片而不是思考块' : '',
      projectAssetIndex.businessVisualEvidenceFeedbackSmokeAvailable ? 'smoke:business-skill:visual-evidence-feedback 已覆盖反馈边界' : '',
      projectAssetIndex.businessVisualEvidenceFeedbackDesktopSmokeAvailable ? 'smoke:chat-ui:business-visual-feedback 已覆盖真实 ChatPanel 卡片渲染位置' : '',
      ...
      projectAssetIndex.agentDiagnosticEvidenceHelperAvailable ? 'src/shared/agent-diagnostic-evidence.ts 已提供隐藏诊断证据白名单与脱敏 helper' : '',
      projectAssetIndex.agentDiagnosticEvidenceSmokeAvailable ? 'smoke:agent:diagnostic-evidence 已覆盖诊断 evidence 脱敏与 Debug Bundle 出口' : '',
      projectAssetIndex.agentAcceptanceDiagnosticControlSmokeAvailable ? 'smoke:agent:acceptance-diagnostic-control 已覆盖 acceptance report 结构化消费业务视觉控制决策' : '',
      projectAssetIndex.agentAcceptanceDiagnosticControlReportAvailable ? 'acceptance report 已暴露 businessSkillVisualEvidenceControlDecision 并检查 no-quality/result-only 边界' : '',
      ...
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceSmokeAvailable ? 'smoke:agent:acceptance-business-skill-evidence 已覆盖业务 skill 执行计划和置入 evidence 进入验收诊断出口' : '',
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceReportAvailable ? 'acceptance report 已暴露 businessSkillExecutionPlanIntake / businessSkillImagePlacementVerificationIntake 并检查隐藏/no-quality 边界' : '',
      projectAssetIndex.agentAcceptanceBusinessSkillEvidenceExportAvailable ? 'acceptanceDiagnostics 已暴露业务 skill evidence intake 边界状态' : '',
      ...
      projectAssetIndex.livePhotoshopAcceptanceEvidenceIntakeHelperAvailable ? 'src/shared/live-photoshop-acceptance-evidence-intake.ts 已提供 live Photoshop artifact 聚焦/截图证据只读 intake' : '',
      ...
      projectAssetIndex.agentAcceptanceDebugCarriesDiagnosticEvidence ? 'Agent acceptance debug bundle 已携带隐藏 diagnosticEvidence' : '',
      ...
      projectAssetIndex.chatPanelExportsDiagnosticEvidence ? 'ChatPanel test bridge 已能从 assistant message 导出隐藏 diagnosticEvidence' : '',
      ...
      projectAssetIndex.businessSkillPreflightPlannerEvidenceHelperAvailable ? 'src/shared/business-skill-preflight-planner-evidence.ts 已把业务执行预检转换成 planner/control 只读证据' : '',
      projectAssetIndex.businessSkillPreflightPlannerEvidenceWired ? '统一 skill executor 结果已附加 businessSkillPreflightPlannerEvidence，不阻断原业务执行' : '',
      projectAssetIndex.businessSkillPreflightPlannerEvidenceNoQualityClaim ? '业务 skill planner/control evidence 明确不能声明设计质量通过' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanHelperAvailable ? 'src/shared/business-skill-visual-evidence-refresh-plan.ts 已提供缺视觉理解时的只读刷新计划' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanSmokeAvailable ? 'smoke:business-skill:visual-evidence-refresh-plan 已覆盖默认禁用、显式启用、runtime 缺口和不改 executor 结果' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanWired ? '统一 skill executor 结果已按需附加 businessSkillVisualEvidenceRefreshPlan，不自动调用模型' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshPlanDefaultDisabled ? '业务视觉证据刷新计划默认禁用，只能由显式 opt-in 后续 runner 执行' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerSmokeAvailable ? 'smoke:business-skill:visual-evidence-refresh-runner 已覆盖双开关、后置执行、红acted summary 和失败不翻转业务结果' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerWired ? '统一 skill executor 已在业务 executor 完成后调用视觉证据刷新 runner' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerPostExecutor ? '业务视觉证据刷新 runner 声明只能在业务 executor 后运行，不能改变当前 Photoshop 输出' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable ? 'smoke:business-skill:visual-evidence-refresh-runtime 已覆盖 renderer runtime 能力自动探测' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeAutoDetects ? '视觉证据刷新计划可从 window.designEcho 自动识别分析和缓存写入能力' : '',
      projectAssetIndex.businessSkillVisualEvidencePreExecutionGateHelperAvailable ? 'src/shared/business-skill-visual-evidence-pre-execution-gate.ts 已提供业务 skill 执行前视觉证据门禁' : '',
      projectAssetIndex.businessSkillVisualEvidencePreExecutionGateSmokeAvailable ? 'smoke:business-skill:visual-evidence-pre-execution-gate 已覆盖默认不阻断、显式前置刷新和 strict 阻断' : '',
      projectAssetIndex.businessSkillVisualEvidencePreExecutionRunnerWired ? '统一 skill executor 已支持显式 opt-in 的执行前视觉证据刷新' : '',
      projectAssetIndex.businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking ? '执行前视觉证据门禁默认不改变业务 executor 行为' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable ? 'smoke:business-skill:visual-evidence-refresh-executor-wiring 已覆盖统一 skill executor 入口' : '',
      projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint ? '统一入口 smoke 验证 executeSkillWithExecutor 后置刷新不改变业务 executor 结果' : '',
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionHelperAvailable ? 'BusinessSkillVisualEvidenceControlDecision 已把 planner/refresh/run 合流为只读控制决策' : '',
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionSmokeAvailable ? 'smoke:business-skill:visual-evidence-control-decision 已覆盖控制决策状态归一化' : '',
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionWired ? '统一 skill executor 已附加 businessSkillVisualEvidenceControlDecision' : '',
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionNoQualityClaim ? '视觉证据控制决策明确不能声明业务设计质量通过' : '',
      projectAssetIndex.businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable ? '隐藏诊断证据已允许携带 businessSkillVisualEvidenceControlDecision' : '',
      projectAssetIndex.businessSkillVisualEvidenceDiagnosticSmokeAvailable ? 'smoke:business-skill:visual-evidence-diagnostic 已覆盖 control decision 进入 Debug Bundle/acceptance 报告' : '',
  ...
  gates.push(buildGate({
    ...
    status: inferStatus([
      ...
      agentPerformancePolicy.planMentionsPerformance
    ], [
  ...
  gates.push(buildGate({
    ...
    status: inferStatus([
      ...
      fileIncludes(agentRoot, 'src/shared/design-planner.ts', 'mapPlannerOutputToDesignAgentOsEvidence'),
      hasScript(packageJson, 'smoke:design-planner:executor-evidence'),
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/design-planner-evidence.ts', 'buildPlannerExecutionPreflightGate'),
    ...
    evidence: [
      ...
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/layout-replication.executor.ts', 'buildReferenceReplicationPlannerEvidence') ? '参考图复刻结果已附加只读 planner evidence 并消费 preflight readiness' : '',
      ...
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/design-planner-evidence.ts', 'comparePlannerExecutionPlanToExecutor') ? '参考图复刻已比较 planner executionPlan 与 executor evidence 类别' : '',
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/main-image.executor.ts', 'buildMainImagePlannerEvidence') ? '主图结果已附加只读 planner evidence' : '',
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/detail-page.executor.ts', 'buildDetailPagePlannerEvidence') ? '详情页结果已附加只读 planner evidence' : '',
      fileIncludes(agentRoot, 'src/renderer/services/skill-executors/sku-batch.executor.ts', 'buildSkuBatchPlannerEvidence') ? 'SKU 结果已附加只读 planner evidence' : ''
    ],
    gaps: [
  ...
  gates.push(buildGate({
    ...
    evidence: [
      ...
      mainImageAgentDraft.designStandardsHelperAvailable ? 'src/shared/main-image-design-standards-evidence.ts 已存在，要求先通过主图设计规范/知识 evidence gate，再进入点击图和转化图策略' : '',
...
function formatReport(report) {
  ...
  lines.push(`- businessVisualEvidenceGateHelperAvailable: ${report.projectAssetIndex.businessVisualEvidenceGateHelperAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackHelperAvailable: ${report.projectAssetIndex.businessVisualEvidenceFeedbackHelperAvailable}`);
  lines.push(`- businessVisualEvidenceGateRendererAvailable: ${report.projectAssetIndex.businessVisualEvidenceGateRendererAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackRendererAvailable: ${report.projectAssetIndex.businessVisualEvidenceFeedbackRendererAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackUiAvailable: ${report.projectAssetIndex.businessVisualEvidenceFeedbackUiAvailable}`);
  lines.push(`- businessVisualEvidenceGateEntrypointWired: ${report.projectAssetIndex.businessVisualEvidenceGateEntrypointWired}`);
  lines.push(`- businessVisualEvidenceGateSmokeAvailable: ${report.projectAssetIndex.businessVisualEvidenceGateSmokeAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackSmokeAvailable: ${report.projectAssetIndex.businessVisualEvidenceFeedbackSmokeAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackDesktopSmokeAvailable: ${report.projectAssetIndex.businessVisualEvidenceFeedbackDesktopSmokeAvailable}`);
  ...
  lines.push(`- agentAcceptanceEvidenceMatrixHelperAvailable: ${report.projectAssetIndex.agentAcceptanceEvidenceMatrixHelperAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixSmokeAvailable: ${report.projectAssetIndex.agentAcceptanceEvidenceMatrixSmokeAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixCommandAvailable: ${report.projectAssetIndex.agentAcceptanceEvidenceMatrixCommandAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixNoQualityClaim: ${report.projectAssetIndex.agentAcceptanceEvidenceMatrixNoQualityClaim}`);
  ...
  lines.push(`- agentAcceptanceDiagnosticControlSmokeAvailable: ${report.projectAssetIndex.agentAcceptanceDiagnosticControlSmokeAvailable}`);
  lines.push(`- agentAcceptanceDiagnosticControlReportAvailable: ${report.projectAssetIndex.agentAcceptanceDiagnosticControlReportAvailable}`);
  ...
  lines.push(`- agentAcceptanceBusinessSkillEvidenceSmokeAvailable: ${report.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceSmokeAvailable}`);
  lines.push(`- agentAcceptanceBusinessSkillEvidenceReportAvailable: ${report.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceReportAvailable}`);
  lines.push(`- agentAcceptanceBusinessSkillEvidenceExportAvailable: ${report.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceExportAvailable}`);
  ...
  lines.push(`- businessSkillExecutionPreflightResultEvidenceOnly: ${report.projectAssetIndex.businessSkillExecutionPreflightResultEvidenceOnly}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceHelperAvailable: ${report.projectAssetIndex.businessSkillPreflightPlannerEvidenceHelperAvailable}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceSmokeAvailable: ${report.projectAssetIndex.businessSkillPreflightPlannerEvidenceSmokeAvailable}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceWired: ${report.projectAssetIndex.businessSkillPreflightPlannerEvidenceWired}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceNoQualityClaim: ${report.projectAssetIndex.businessSkillPreflightPlannerEvidenceNoQualityClaim}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanHelperAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanWired: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanWired}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanDefaultDisabled: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanDefaultDisabled}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerWired: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerWired}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerPostExecutor: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerPostExecutor}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRuntimeAutoDetects: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeAutoDetects}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateHelperAvailable: ${report.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateWired: ${report.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateWired}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionRunnerWired: ${report.projectAssetIndex.businessSkillVisualEvidencePreExecutionRunnerWired}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking: ${report.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking}`);
  lines.push(`- businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint: ${report.projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionHelperAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceControlDecisionHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceControlDecisionSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionWired: ${report.projectAssetIndex.businessSkillVisualEvidenceControlDecisionWired}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionNoQualityClaim: ${report.projectAssetIndex.businessSkillVisualEvidenceControlDecisionNoQualityClaim}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable}`);
  ...
  lines.push(`- businessSkillVisualEvidenceDiagnosticSmokeAvailable: ${report.projectAssetIndex.businessSkillVisualEvidenceDiagnosticSmokeAvailable}`);
  ...
  lines.push(`- planMentionsPerformance: ${report.agentPerformancePolicy.planMentionsPerformance}`);
  lines.push('');
