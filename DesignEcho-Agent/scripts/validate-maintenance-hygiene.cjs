...
function main() {
  ...
  run('node', ['--check', 'scripts/smoke-business-skill-preflight-planner-evidence.cjs'], { cwd: agentRoot });
  ...
  run('node', ['--check', 'scripts/smoke-business-skill-visual-evidence-control-decision.cjs'], { cwd: agentRoot });
  ...
  run('node', ['--check', 'scripts/smoke-agent-acceptance-business-skill-evidence.cjs'], { cwd: agentRoot });
  ...
  run('node', ['--check', 'scripts/smoke-agent-acceptance-evidence-matrix.cjs'], { cwd: agentRoot });
  run('node', ['--check', 'scripts/report-agent-acceptance-evidence-matrix.cjs'], { cwd: agentRoot });
  ...
  run('node', ['scripts/smoke-business-skill-preflight-planner-evidence.cjs'], { cwd: agentRoot });
  ...
  run('node', ['scripts/smoke-business-skill-visual-evidence-control-decision.cjs'], { cwd: agentRoot });
  ...
  run('node', ['scripts/smoke-agent-acceptance-business-skill-evidence.cjs'], { cwd: agentRoot });
  ...
  run('node', ['scripts/smoke-agent-acceptance-evidence-matrix.cjs'], { cwd: agentRoot });
  ...
  run('node', ['scripts/smoke-main-image-design-standards-evidence.cjs'], { cwd: agentRoot });
  ...
  run('node', ['--check', 'scripts/smoke-main-image-design-standards-evidence.cjs'], { cwd: agentRoot });
  ...
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessVisualEvidenceGateHelperAvailable',
    'project cockpit business visual evidence gate export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessVisualEvidenceFeedbackUiAvailable',
    'project cockpit business visual evidence feedback UI export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessVisualEvidenceFeedbackDesktopSmokeAvailable',
  ...
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshPlanSmokeAvailable',
    'project cockpit business skill visual evidence refresh plan smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshPlanDefaultDisabled',
    'project cockpit business skill visual evidence refresh plan default disabled export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshRunnerSmokeAvailable',
    'project cockpit business skill visual evidence refresh runner smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshRunnerPostExecutor',
    'project cockpit business skill visual evidence refresh runner post-executor export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable',
    'project cockpit business skill visual evidence refresh runtime smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable',
    'project cockpit business skill visual evidence refresh executor wiring smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionSmokeAvailable',
    'project cockpit business skill visual evidence control decision smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionNoQualityClaim',
    'project cockpit business skill visual evidence control decision no-quality-claim export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable',
    'project cockpit business skill visual evidence control decision diagnostic export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
  ...
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'agentAcceptanceDiagnosticControlSmokeAvailable',
    'project cockpit agent acceptance diagnostic control smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
  ...
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'agentAcceptanceBusinessSkillEvidenceSmokeAvailable',
  ...
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'agentAcceptanceEvidenceMatrixSmokeAvailable',
    'project cockpit agent acceptance evidence matrix smoke export'
  );
  assertIncludes(
    readProjectCockpitJson(agentRoot),
    'agentAcceptanceEvidenceMatrixCommandAvailable',
  ...
  assertIncludes(
    run('node', ['scripts/report-change-boundaries.cjs', '--validation', 'agent-routing-models'], { cwd: agentRoot, capture: true }),
    'smoke:business-skill:preflight-planner-evidence',
    'change-boundaries business skill preflight planner evidence validation export'
  );
  assertIncludes(
    run('node', ['scripts/report-change-boundaries.cjs', '--validation', 'agent-routing-models'], { cwd: agentRoot, capture: true }),
  ...
  assertIncludes(
    run('node', ['scripts/report-change-boundaries.cjs', '--validation', 'agent-routing-models'], { cwd: agentRoot, capture: true }),
    'smoke:agent:acceptance-evidence-matrix',
  ...
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessVisualEvidenceGateSmokeAvailable',
    'agent architecture business visual evidence gate export'
  );
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessVisualEvidenceFeedbackSmokeAvailable',
  ...
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionSmokeAvailable',
    'agent architecture business skill visual evidence control decision smoke export'
  );
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionNoQualityClaim',
    'agent architecture business skill visual evidence control decision no-quality-claim export'
  );
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable',
    'agent architecture business skill visual evidence control decision diagnostic export'
  );
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'businessSkillExecutionIntakeSmokeAvailable',
  ...
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'agentAcceptanceDiagnosticControlSmokeAvailable',
    'agent architecture acceptance diagnostic control smoke export'
  );
  assertIncludes(
    readAgentArchitectureJson(agentRoot),
    'agentAcceptanceDiagnosticExportSmokeAvailable',
  ...
  run('git', [
    ...
    'DesignEcho-Agent/scripts/smoke-business-skill-preflight-planner-evidence.cjs',
    ...
    'DesignEcho-Agent/scripts/smoke-business-skill-visual-evidence-control-decision.cjs',
    ...
    'DesignEcho-Agent/scripts/smoke-agent-acceptance-business-skill-evidence.cjs',
    'DesignEcho-Agent/scripts/smoke-live-photoshop-acceptance-evidence-intake.cjs',
    ...
    'DesignEcho-Agent/scripts/smoke-agent-acceptance-evidence-matrix.cjs',
    'DesignEcho-Agent/scripts/report-agent-acceptance-evidence-matrix.cjs',
    ...
    'DesignEcho-Agent/src/shared/agent-acceptance-evidence-matrix.ts',
    'DesignEcho-Agent/src/shared/live-photoshop-acceptance-evidence-intake.ts',
    ...
    'DesignEcho-Agent/scripts/smoke-main-image-design-standards-evidence.cjs',
    ...
    'DesignEcho-Agent/src/shared/main-image-design-standards-evidence.ts',
    ...
    'DesignEcho-Agent/src/shared/business-skill-preflight-planner-evidence.ts',
    'DesignEcho-Agent/src/shared/business-skill-visual-evidence-refresh-plan.ts',
    'DesignEcho-Agent/src/shared/business-skill-visual-evidence-pre-execution-gate.ts',
    'DesignEcho-Agent/src/shared/business-skill-visual-evidence-control-decision.ts',
    ...
    'DesignEcho-Agent/src/shared/agent-diagnostic-evidence.ts',
    ...
    'DesignEcho-Agent/src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
    'DesignEcho-Agent/src/renderer/services/skill-executors/business-skill-visual-evidence-runtime.ts',
    'DesignEcho-Agent/src/renderer/services/skill-executors/design-planner-evidence.ts',
