...
const BOUNDARIES = [
  ...
  },
  {
    ...
    match: (entry) => /design-learning-candidates|design-workshop\/(design-evaluator|evaluate-design\.executor)|verify-design-learning-candidates/.test(entry.filePath)
  },
  {
