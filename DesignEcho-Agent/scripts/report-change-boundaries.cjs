...
const BOUNDARIES = [
  ...
  },
  {
    ...
    title: 'Photoshop 验收与 Debug 证据基础设施',
    validation: [
      'npm run build:main',
      'npm run build:typecheck:renderer',
  ...
  },
  {
    ...
    validation: ['npm run smoke:agent:planning-contract', 'npm run smoke:chat-ui:execution-chain', 'npm run build:main', 'npm run build:typecheck:renderer'],
    match: (entry) => /agent-task-public-plan-(approval-record|controlled-runner)/.test(entry.filePath)
  },
  {
    id: 'agent-routing-models',
    title: 'Agent 路由 / 模型 / skill 边界',
    validation: ['npm run build:main', 'npm run build:typecheck:renderer', 'npm run smoke:agent:intent-engine', 'npm run smoke:agent:planning-contract', 'npm run smoke:agent:intent-boundary-matrix', 'npm run smoke:agent:resumable-task-contract', 'npm run smoke:agent:resume-readonly-runtime', 'npm run smoke:agent:intent-decision-intake', 'npm run smoke:agent:intent-deliberation-gate', 'npm run smoke:agent:visible-activity', 'npm run smoke:agent:worker-identity', 'npm run smoke:agent:acceptance-runtime-mode', 'npm run smoke:agent:observation-channels', 'npm run smoke:agent:provider-observation-capabilities', 'npm run smoke:provider-native:tools', 'npm run smoke:design-knowledge:xiaomi-web-search-runtime', 'npm run smoke:agent:execution-lifecycle', 'npm run smoke:agent:execution-lifecycle-acceptance', 'npm run smoke:detail-page:document-preflight-routing', 'npm run smoke:detail-page:skill-readiness', 'npm run smoke:detail-page:readiness-wiring', 'npm run smoke:detail-page:dpi-readonly-evidence', 'npm run smoke:agent:diagnostic-evidence', 'npm run smoke:agent:design-execution-preflight', 'npm run smoke:sku:design-preflight', 'npm run smoke:business-skill:implementation-checkpoint', 'npm run smoke:business-skill:readiness-contract', 'npm run smoke:business-skill:execution-preflight-gate', 'npm run smoke:business-skill:execution-preflight-wiring', 'npm run smoke:business-skill:preflight-planner-evidence', 'npm run smoke:business-skill:visual-evidence-refresh-plan', 'npm run smoke:business-skill:visual-evidence-refresh-runner', 'npm run smoke:business-skill:visual-evidence-refresh-runtime', 'npm run smoke:business-skill:visual-evidence-pre-execution-gate', 'npm run smoke:business-skill:visual-evidence-refresh-executor-wiring', 'npm run smoke:business-skill:visual-evidence-control-decision', 'npm run smoke:business-skill:execution-intake', 'npm run smoke:project-asset-understanding:intake', 'npm run smoke:business-skill:image-placement-verification-intake', 'npm run smoke:business-skill:execution-plan-intake', 'npm run smoke:business-skill:visual-evidence-diagnostic', 'npm run smoke:agent:acceptance-diagnostic-control', 'npm run smoke:agent:acceptance-diagnostic-export', 'npm run smoke:agent:acceptance-business-skill-evidence', 'npm run smoke:live-photoshop:acceptance-evidence-intake', 'npm run smoke:agent:acceptance-triage', 'npm run smoke:agent:acceptance-triage-report', 'npm run maintenance:acceptance-triage-report', 'npm run smoke:agent:acceptance-evidence-matrix', 'npm run maintenance:acceptance-evidence-matrix', 'npm run smoke:agent:acceptance-execution-suite', 'npm run maintenance:acceptance-suite', 'npm run smoke:agent:acceptance-control-plane', 'npm run smoke:agent:performance-policy', 'npm run smoke:agent:tool-decision-contract', 'npm run smoke:agent:tool-execution-preflight', 'npm run smoke:agent:tool-stream', 'npm run smoke:document-management:skill', 'npm run smoke:layer-management:skill', 'npm run smoke:find-smart:observability', 'npm run smoke:model-selection:routing', 'npm run smoke:model-routing:live-quality', 'npm run smoke:agent:runtime-guard', 'npm run smoke:agent:step-events', 'npm run smoke:agent:task-completion-contract', 'npm run smoke:tool-dependencies:param-targets', 'npm run smoke:design-team:coordinator', 'npm run smoke:design-intelligence:plan', 'npm run smoke:design-planner:mvp', 'npm run smoke:design-planner:executor-evidence', 'npm run smoke:project-asset-index', 'npm run smoke:project-visual-sampling', 'npm run smoke:project-visual-insight-cache', 'npm run smoke:project-visual-insight-cache-fill', 'npm run smoke:design-knowledge:eagle-candidate-visual-insight-request', 'npm run smoke:business-skill:visual-evidence-gate', 'npm run smoke:business-skill:visual-evidence-feedback', 'npm run smoke:business-skill:design-governance', 'npm run smoke:image-placement:core', 'npm run smoke:image-placement:readiness', 'npm run smoke:chat-ui:business-visual-feedback', 'npm run smoke:project-context-runtime', 'npm run smoke:main-image:asset-selection', 'npm run smoke:main-image:visual-loop', 'npm run smoke:main-image:vision-preflight', 'npm run smoke:main-image:candidate-preflight', 'npm run smoke:main-image:execution-alignment', 'npm run smoke:main-image:screenshot-qa', 'npm run smoke:main-image:screenshot-probe-readiness', 'npm run smoke:main-image:pixel-probe-adapter', 'npm run smoke:main-image:qa-report', 'npm run smoke:main-image:controlled-product-qa-gate', 'npm run smoke:main-image:controlled-product-qa-bridge', 'npm run smoke:main-image:agent-draft-plan', 'npm run smoke:main-image:strategy-contract', 'npm run smoke:main-image:strategy-input-builder', 'npm run smoke:main-image:dpi-readonly-evidence', 'npm run smoke:sku:dpi-readonly-evidence', 'npm run smoke:main-image:asset-hero-strategy', 'npm run smoke:main-image:design-standards', 'npm run smoke:main-image:design-readiness', 'npm run smoke:main-image:live-executor-checkpoint', 'npm run smoke:main-image:live-photoshop-adapter-contract', 'npm run smoke:design-knowledge:search', 'npm run smoke:design-knowledge:searxng', 'npm run smoke:design-knowledge:settings-entry', 'npm run smoke:design-knowledge:runtime-capability', 'npm run smoke:design-knowledge:eagle-readonly', 'npm run smoke:design-knowledge:eagle-case-index', 'npm run smoke:knowledge:eagle-writeback-gate', 'npm run smoke:design-placement:intelligence', 'npm run smoke:model-provider:xiaomi', 'npm run smoke:model-provider:deepseek', 'npm run smoke:provider-stream:policy', 'npm run smoke:stream-chat-service:errors', 'npm run smoke:chat-error:summary'],
    match: (entry) => /agent-runtime|agent-orchestration|agent-tool-stream|agent-tool-decision-contract|agent-tool-execution-preflight|agent-capability-gate|agent-request-lifecycle|agent-task-planning-contract|agent-task-public-plan-(readonly-context|execution-request)|agent-resumable-task-contract|agent-resume-execution-policy|agent-resume-execution-gate|agent-resume-controlled-execution|agent-resume-context-gate|agent-resume-context-refresh-runner|agent-resume-readonly-context-executor|resume-readonly-handlers|agent-resume-planning|agent-execution-lifecycle|agent-route-boundary-policy|agent-observation-channels|agent-provider-observation-capabilities|provider-native-tools|searxng-design-knowledge|eagle-readonly-knowledge|eagle-visual-case-index|eagle-candidate-visual-insight-request|eagle-writeback-gate|eagle-knowledge-handlers|design-knowledge-settings|design-knowledge-runtime-capability|design-knowledge-handlers|agent-intent-(control-plane|decision-intake|deliberation-gate)|agent-(preference-feedback|response-knowledge)|agent-diagnostic-evidence|agent-design-execution-preflight|agent-acceptance-contracts|agent-acceptance-export|agent-acceptance-triage|agent-acceptance-control-plane|agent-acceptance-evidence-matrix|agent-acceptance-execution-suite|agent-acceptance-runtime-mode|live-photoshop-acceptance-evidence-intake|run-agent-acceptance-suite|design-agent|agent-performance-policy|design-intelligence-plan|design-placement-intelligence|design-planner|detail-page-skill-readiness|business-skill-(memory-evidence|visual-evidence-(gate|feedback|refresh-plan|refresh-runner|pre-execution-gate|control-decision|diagnostic|runtime)|design-governance|implementation-checkpoint|readiness-contract|execution-preflight-gate|preflight-planner-evidence|execution-intake|image-placement-verification-intake|execution-plan-intake)|project-asset-understanding|design-image-placement-core|image-placement-core-mvp|report-image-placement-core-readiness|project-asset-index|project-visual-sampling|project-visual-insight-cache|project-context-snapshot-service|project-context-runtime|ecommerce-project-handlers|main-image-(agent-draft-plan|strategy-contract|strategy-input-builder|asset-hero-strategy|design-standards-evidence|design-readiness-report|live-executor-request|live-executor-(checkpoint|runner)|controlled-product-qa-gate|controlled-product-qa-bridge|live-photoshop-adapter-contract|asset-selection|visual-loop|vision-preflight|execution-alignment|screenshot-qa|screenshot-probe-readiness|qa-report|memory-evidence)|resource-manager-service|resource-handlers|preload\.ts|types\.d\.ts|design-teams|design-team|design-domain-knowledge|design-knowledge-search|design-memory-knowledge|memory\.service|design-grid-dsl|model-selection|skill-routing|skill-declarations|tool-dependencies|models\.config|model-service|task-orchestrator|stream-chat\.service|shared\/prompts\/(agent-prompt|enhanced-agent-prompt|visual-understanding)|document-management\.executor|layer-management\.executor|find-edit-element\.executor|smoke-agent-(intent-engine|planning-contract|intent-boundary-matrix|resumable-task-contract|resume-readonly-runtime-wiring|intent-decision-intake|intent-deliberation-gate|visible-activity|worker-identity|acceptance-runtime-mode|observation-channels|provider-observation-capabilities|execution-lifecycle|diagnostic-evidence|design-execution-preflight|acceptance-diagnostic-(control|export)|acceptance-business-skill-evidence|acceptance-triage|acceptance-evidence-matrix|acceptance-execution-suite|acceptance-control-plane|performance-policy|tool-decision-contract|tool-execution-preflight|tool-stream|runtime-guard|step-events|task-completion-contract|preference-feedback|response-knowledge)|smoke-agent-tool-decision-contract|smoke-detail-page-(document-preflight-routing|skill-readiness|readiness-wiring|dpi-readonly-evidence)|smoke-provider-native-tools|smoke-searxng-design-knowledge|smoke-design-knowledge-settings-entry|smoke-design-knowledge-runtime-capability|smoke-design-knowledge-eagle-readonly|smoke-design-knowledge-eagle-case-index|smoke-eagle-writeback-gate|smoke-design-placement-intelligence|smoke-xiaomi-web-search-runtime-wiring|smoke-live-photoshop-acceptance-evidence-intake|report-agent-acceptance-evidence-matrix|smoke-business-skill-(implementation-checkpoint|readiness-contract|execution-preflight-gate|execution-preflight-wiring|preflight-planner-evidence|execution-intake|image-placement-verification-intake|execution-plan-intake|memory-evidence|visual-evidence-refresh-(plan|runner|runtime|executor-wiring)|visual-evidence-pre-execution-gate|visual-evidence-(control-decision|diagnostic|gate|feedback)|design-governance)|smoke-project-asset-understanding-intake|smoke-project-asset-index|smoke-project-visual-sampling|smoke-project-visual-insight-cache|smoke-image-placement-(core|readiness)|smoke-chat-ui-business-visual-feedback|smoke-project-context-runtime|smoke-main-image-(agent-draft-plan|strategy-contract|strategy-input-builder|dpi-readonly-evidence|asset-hero-strategy|design-standards-evidence|design-readiness-report|live-executor-request|live-executor-checkpoint|live-photoshop-adapter-contract|live-tool-adapter-disposable|asset-selection|visual-loop|vision-preflight|candidate-preflight|execution-alignment|screenshot-qa|screenshot-probe-readiness|pixel-probe-adapter|controlled-product-qa-gate|controlled-product-qa-bridge|qa-report|memory-evidence)|smoke-sku-(design-preflight|dpi-readonly-evidence)|report-main-image-screenshot-probe-readiness|smoke-design-knowledge-search|smoke-design-memory-knowledge|smoke-preferences-(service-contract|settings-entry)|smoke-provider-stream-policy|smoke-stream-chat-service-errors|smoke-chat-error-summary|smoke-model-selection-routing|smoke-model-routing-live-quality|smoke-tool-dependencies-param-targets|smoke-skill-boundaries|smoke-document-management-skill|smoke-layer-management-skill|smoke-find-smart-observability|smoke-design-team-coordinator|smoke-design-grid-dsl|smoke-model-provider-(deepseek|xiaomi)/.test(entry.filePath)
  },
  {
  ...
  },
  {
    ...
    validation: ['npm run build:typecheck:renderer', 'npm run smoke:ui:workbench-information-architecture', 'npm run smoke:ui:user-facing-language-boundary', 'npm run smoke:ui:agent-process-inspector', 'npm run smoke:ui:human-review-intake', 'npm run smoke:ui:human-review-record-persistence', 'npm run smoke:ui:asset-gallery-polish', 'npm run smoke:ui:eagle-asset-candidates', 'npm run smoke:ui:design-result-review-panel'],
    match: (entry) => /src\/renderer\/(App|types)\.(tsx?|d\.ts)$|src\/renderer\/index\.html|components\/Header\.tsx|components\/(DesignAgentWorkbench\.(tsx|css)|EagleAssetCandidatesPanel\.tsx|AssetGallery\.tsx|asset-gallery-view-model\.ts)|ChatPanel|SettingsModal|ThinkingProcess|ExecutionStatus|hooks\/(index|useChatActions|useExecution)\.ts|app\.store|components\/message\/MessageRenderer\.css|components\/message\/blocks\/(ThinkingBlock|ToolResultBlock)|components\/message\/parser\.ts|services\/(agent-visible-feedback|tool-display-info|memory|eagle-asset-candidates)\.service\.ts|src\/shared\/agent-process-inspector\.ts|src\/shared\/design-result-review-panel\.ts|src\/shared\/eagle-asset-candidates-panel\.ts|src\/shared\/eagle-candidate-visual-handoff\.ts|src\/shared\/human-review-(intake|record)\.ts|smoke-ui-(workbench-information-architecture|user-facing-language-boundary|agent-process-inspector|human-review-intake|asset-gallery-polish|eagle-asset-candidates|design-result-review-panel)|smoke-human-review-record-persistence|public\/webview\/design-library\.js/.test(entry.filePath)
  },
  {
    id: 'design-skill-execution-core',
    title: '设计 skill 与执行核心',
    validation: ['npm run build:main', 'npm run build:typecheck:renderer', 'npm run smoke:agent:intent-engine', 'npm run smoke:ecommerce-socks-design:entry', 'npm run smoke:ecommerce-socks-design:strategy-checkpoint', 'npm run smoke:ecommerce-socks-design:child-strategy-packets', 'npm run smoke:ecommerce-socks-design:child-strategy-review-gate', 'npm run smoke:ecommerce-socks-design:dispatch-checkpoint', 'npm run smoke:ecommerce-socks-design:dispatch-lifecycle', 'npm run smoke:ecommerce-socks-design:dispatch-orchestration', 'npm run smoke:ecommerce-socks-design:dispatch-authorization', 'npm run smoke:ecommerce-socks-design:child-dispatch-runner', 'npm run smoke:ecommerce-socks-design:child-report-aggregation', 'npm run smoke:main-image:design-skill', 'npm run smoke:main-image:strategy-contract', 'npm run smoke:main-image:strategy-input-builder', 'npm run smoke:main-image:asset-hero-strategy', 'npm run smoke:main-image:project-style-strategy', 'npm run smoke:main-image:design-standards', 'npm run smoke:main-image:design-readiness', 'npm run smoke:main-image:live-executor-checkpoint', 'npm run smoke:main-image:live-photoshop-adapter-contract', 'npm run smoke:main-image:live-adapter-handoff', 'npm run smoke:main-image:disposable-product-e2e:self-test', 'npm run smoke:main-image:disposable-product-e2e', 'npm run smoke:main-image:executor-controlled-product-branch', 'npm run smoke:main-image:controlled-product-qa-gate', 'npm run smoke:main-image:controlled-product-qa-bridge', 'npm run smoke:uxp:layer-hierarchy-tools', 'npm run smoke:uxp:group-export-tool', 'npm run smoke:main-image:photoshop-tool-capability-matrix', 'npm run smoke:main-image:group-hierarchy-contract', 'npm run smoke:main-image:variant-placement-strategy', 'npm run smoke:main-image:production-structure', 'npm run smoke:main-image:production-execution-plan', 'npm run smoke:main-image:production-executor-handoff', 'npm run smoke:main-image:production-executor-bridge', 'npm run smoke:main-image:production-executor-dry-run', 'npm run smoke:text-font-replace:skill', 'npm run smoke:detail-page:mcp', 'npm run smoke:detail-page:template-parser-policy', 'npm run smoke:sku:self-select-note-policy', 'npm run smoke:sku:contrast-pair-policy', 'npm run smoke:matte-product:skill', 'npm run smoke:template-project:observability', 'npm run smoke:analysis-reference:observability', 'npm run smoke:find-smart:observability', 'npm run smoke:template-authoring:observability', 'npm run smoke:copywriting:framework'],
    match: (entry) => /ecommerce-socks-design|ecommerce-socks-strategy-checkpoint|ecommerce-socks-child-strategy-packets|ecommerce-socks-child-strategy-review-gate|detail-page\.executor|detail-page-parser|detail-page-screen-plan|smoke-detail-page-(template-(parser-policy|live-case|export-policy)|agent-decision-boundary)|detail-page-template-authoring\.(executor|skill)|detail-page-design\.skill|main-image-template-(authoring\.(executor|skill)|blueprint)|main-image-design\.skill|main-image-(strategy-contract|asset-hero-strategy|project-style-strategy|design-standards-evidence|design-readiness-report|live-executor-request|live-executor-(checkpoint|runner)|controlled-product-qa-gate|controlled-product-qa-bridge|live-photoshop-adapter-contract|live-adapter-handoff|live-photoshop-tool-adapter|photoshop-tool-capability-matrix|group-hierarchy-contract|variant-placement-strategy|production-document-structure|production-execution-plan|production-executor-handoff|production-executor-bridge|production-executor-dry-run|copy-evidence|design-concept-plan|design-core)|main-image\.executor|sku-batch\.executor|text-font-replace\.executor|matte-product\.executor|template-save\.executor|project-image-analysis\.executor|agent-panel-bridge\.executor|design-reference-search\.executor|visual-analysis\.executor|find-edit-element\.executor|smart-layout\.executor|skill-step-events|sku-self-select-note-policy|sku-intent-params|knowledge\/socks-categories|agent-system-prompt|smoke-sku-(self-select-note-policy|contrast-pair-policy|intent-params|result-status|project-source-policy)|smoke-main-image-(design-skill|template-authoring-skill|strategy-contract|strategy-input-builder|dpi-readonly-evidence|asset-hero-strategy|project-style-strategy|design-standards-evidence|design-readiness-report|live-executor-request|live-executor-(checkpoint|runner)|controlled-product-qa-gate|controlled-product-qa-bridge|live-photoshop-adapter-contract|live-adapter-handoff|live-photoshop-tool-adapter|disposable-product-e2e|executor-controlled-product-branch|uxp-toolchain-live|photoshop-tool-capability-matrix|group-hierarchy-contract|variant-placement-strategy|production-structure|production-execution-plan|production-executor-handoff|production-executor-bridge|production-executor-dry-run|copy-evidence|design-concept-plan|design-core)|smoke-uxp-layer-hierarchy-tools|smoke-uxp-group-export-tool|smoke-text-font-replace-skill|smoke-matte-product-skill|smoke-template-project-observability|smoke-analysis-reference-observability|smoke-find-smart-observability|smoke-template-authoring-observability|smoke-text-optimization-contract|smoke-copywriting-framework|design-copywriting-framework|uxp-handlers\/text-handlers|matting-service|autonomous-agent\.executor|skill-executors\/index\.ts|skill-executors\/types\.ts|tool-executor\.service|template-knowledge\.service|reference-analysis|skill-param-defaults|types\/skill\.types/.test(entry.filePath)
  },
  {
    id: 'package-and-deps',
    title: '包配置、依赖与构建配置',
