...
function buildCockpit(limit) {
  ...
  return {
    ...
    mainImageAgentDraft: {
      ...
      designStandardsHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/main-image-design-standards-evidence.ts')),
    ...
    projectAssetIndex: {
      ...
      businessVisualEvidenceGateHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-visual-evidence-gate.ts')),
      businessVisualEvidenceFeedbackHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-visual-evidence-feedback.ts')),
      ...
      businessVisualEvidenceGateSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-gate']),
      businessVisualEvidenceFeedbackSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-feedback']),
      businessVisualEvidenceFeedbackDesktopSmokeAvailable: Boolean(packageJson.scripts?.['smoke:chat-ui:business-visual-feedback']),
      ...
      agentDiagnosticEvidenceHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/agent-diagnostic-evidence.ts')),
      agentDiagnosticEvidenceSmokeAvailable: Boolean(packageJson.scripts?.['smoke:agent:diagnostic-evidence']),
      agentAcceptanceDebugCarriesDiagnosticEvidence: fileIncludes(
        agentRoot,
        'src/shared/agent-acceptance-contracts.ts',
        'diagnosticEvidence'
      ),
      agentAcceptanceDiagnosticControlSmokeAvailable: Boolean(packageJson.scripts?.['smoke:agent:acceptance-diagnostic-control']),
      ...
      agentAcceptanceBusinessSkillEvidenceSmokeAvailable: Boolean(packageJson.scripts?.['smoke:agent:acceptance-business-skill-evidence']),
      ...
      livePhotoshopAcceptanceEvidenceIntakeHelperAvailable: fs.existsSync(
        path.join(agentRoot, 'src/shared/live-photoshop-acceptance-evidence-intake.ts')
      ),
      ...
      agentAcceptanceEvidenceMatrixHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/agent-acceptance-evidence-matrix.ts')),
      agentAcceptanceEvidenceMatrixSmokeAvailable: Boolean(packageJson.scripts?.['smoke:agent:acceptance-evidence-matrix']),
      agentAcceptanceEvidenceMatrixCommandAvailable: Boolean(packageJson.scripts?.['maintenance:acceptance-evidence-matrix']),
      ...
      businessSkillPreflightPlannerEvidenceHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-preflight-planner-evidence.ts')),
      businessSkillPreflightPlannerEvidenceSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:preflight-planner-evidence']),
      ...
      businessSkillVisualEvidenceRefreshPlanHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-visual-evidence-refresh-plan.ts')),
      businessSkillVisualEvidenceRefreshPlanSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-refresh-plan']),
      ...
      businessSkillVisualEvidenceRefreshRunnerSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-refresh-runner']),
      ...
      businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-refresh-runtime']),
      businessSkillVisualEvidenceRefreshRuntimeAutoDetects: fileIncludes(
        agentRoot,
        'src/renderer/services/skill-executors/business-skill-visual-evidence-gate.ts',
        'detectBusinessSkillVisualEvidenceRefreshRuntime'
      ),
      businessSkillVisualEvidencePreExecutionGateHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-visual-evidence-pre-execution-gate.ts')),
      businessSkillVisualEvidencePreExecutionGateSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-pre-execution-gate']),
      ...
      businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-refresh-executor-wiring']),
      ...
      businessSkillVisualEvidenceControlDecisionHelperAvailable: fs.existsSync(path.join(agentRoot, 'src/shared/business-skill-visual-evidence-control-decision.ts')),
      businessSkillVisualEvidenceControlDecisionSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-control-decision']),
      ...
      businessSkillVisualEvidenceDiagnosticSmokeAvailable: Boolean(packageJson.scripts?.['smoke:business-skill:visual-evidence-diagnostic']),
    ...
    commands: {
      ...
      quickValidation: 'npm run maintenance:validate',
...
function formatCockpit(cockpit) {
  ...
  lines.push(`- businessVisualEvidenceGateHelperAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceGateHelperAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackHelperAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceFeedbackHelperAvailable}`);
  lines.push(`- businessVisualEvidenceGateRendererAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceGateRendererAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackRendererAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceFeedbackRendererAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackUiAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceFeedbackUiAvailable}`);
  lines.push(`- businessVisualEvidenceGateEntrypointWired: ${cockpit.projectAssetIndex.businessVisualEvidenceGateEntrypointWired}`);
  ...
  lines.push(`- businessVisualEvidenceGateSmokeAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceGateSmokeAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackSmokeAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceFeedbackSmokeAvailable}`);
  lines.push(`- businessVisualEvidenceFeedbackDesktopSmokeAvailable: ${cockpit.projectAssetIndex.businessVisualEvidenceFeedbackDesktopSmokeAvailable}`);
  ...
  lines.push(`- agentDiagnosticEvidenceHelperAvailable: ${cockpit.projectAssetIndex.agentDiagnosticEvidenceHelperAvailable}`);
  lines.push(`- agentDiagnosticEvidenceSmokeAvailable: ${cockpit.projectAssetIndex.agentDiagnosticEvidenceSmokeAvailable}`);
  lines.push(`- agentAcceptanceDebugCarriesDiagnosticEvidence: ${cockpit.projectAssetIndex.agentAcceptanceDebugCarriesDiagnosticEvidence}`);
  ...
  lines.push(`- agentAcceptanceEvidenceMatrixHelperAvailable: ${cockpit.projectAssetIndex.agentAcceptanceEvidenceMatrixHelperAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixSmokeAvailable: ${cockpit.projectAssetIndex.agentAcceptanceEvidenceMatrixSmokeAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixCommandAvailable: ${cockpit.projectAssetIndex.agentAcceptanceEvidenceMatrixCommandAvailable}`);
  lines.push(`- agentAcceptanceEvidenceMatrixNoQualityClaim: ${cockpit.projectAssetIndex.agentAcceptanceEvidenceMatrixNoQualityClaim}`);
  ...
  lines.push(`- agentAcceptanceDiagnosticControlSmokeAvailable: ${cockpit.projectAssetIndex.agentAcceptanceDiagnosticControlSmokeAvailable}`);
  lines.push(`- agentAcceptanceDiagnosticControlReportAvailable: ${cockpit.projectAssetIndex.agentAcceptanceDiagnosticControlReportAvailable}`);
  ...
  lines.push(`- agentAcceptanceBusinessSkillEvidenceSmokeAvailable: ${cockpit.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceSmokeAvailable}`);
  lines.push(`- agentAcceptanceBusinessSkillEvidenceReportAvailable: ${cockpit.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceReportAvailable}`);
  lines.push(`- agentAcceptanceBusinessSkillEvidenceExportAvailable: ${cockpit.projectAssetIndex.agentAcceptanceBusinessSkillEvidenceExportAvailable}`);
  ...
  lines.push(`- chatPanelExportsDiagnosticEvidence: ${cockpit.projectAssetIndex.chatPanelExportsDiagnosticEvidence}`);
  ...
  lines.push(`- businessSkillExecutionPreflightResultEvidenceOnly: ${cockpit.projectAssetIndex.businessSkillExecutionPreflightResultEvidenceOnly}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceHelperAvailable: ${cockpit.projectAssetIndex.businessSkillPreflightPlannerEvidenceHelperAvailable}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillPreflightPlannerEvidenceSmokeAvailable}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceWired: ${cockpit.projectAssetIndex.businessSkillPreflightPlannerEvidenceWired}`);
  lines.push(`- businessSkillPreflightPlannerEvidenceNoQualityClaim: ${cockpit.projectAssetIndex.businessSkillPreflightPlannerEvidenceNoQualityClaim}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanHelperAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanWired: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanWired}`);
  lines.push(`- businessSkillVisualEvidenceRefreshPlanDefaultDisabled: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshPlanDefaultDisabled}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerWired: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerWired}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRunnerPostExecutor: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshRunnerPostExecutor}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshRuntimeAutoDetects: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshRuntimeAutoDetects}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateHelperAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateWired: ${cockpit.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateWired}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionRunnerWired: ${cockpit.projectAssetIndex.businessSkillVisualEvidencePreExecutionRunnerWired}`);
  lines.push(`- businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking: ${cockpit.projectAssetIndex.businessSkillVisualEvidencePreExecutionGateDefaultNonBlocking}`);
  lines.push(`- businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceRefreshExecutorWiringCoversUnifiedEntrypoint}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionHelperAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceControlDecisionHelperAvailable}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceControlDecisionSmokeAvailable}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionWired: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceControlDecisionWired}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionNoQualityClaim: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceControlDecisionNoQualityClaim}`);
  lines.push(`- businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceControlDecisionDiagnosticEvidenceAvailable}`);
  ...
  lines.push(`- businessSkillVisualEvidenceDiagnosticSmokeAvailable: ${cockpit.projectAssetIndex.businessSkillVisualEvidenceDiagnosticSmokeAvailable}`);
