...
assert(summary.evidenceBoundary === 'insufficient_runtime_evidence', 'summary should expose the evidence boundary', summary);
...
assert(markdown.includes('- evidenceBoundary: insufficient_runtime_evidence'), 'markdown should include evidence boundary', markdown);
...
console.log(JSON.stringify({
  ...
  checks: [
    ...
    'acceptance triage markdown exposes status, issue layer, owner, evidence boundary and next actions',
