...
assert(selectedHandoff.visualAnalysisRequest.shouldRequestVisualAnalysis === true, 'selected handoff should request visual analysis evidence', selectedHandoff);
assert(selectedHandoff.visualAnalysisRequest.requestedEvidence.includes('subject_regions'), 'handoff should require subject region evidence', selectedHandoff);
assert(selectedHandoff.visualAnalysisRequest.requestedEvidence.includes('composition'), 'handoff should require composition evidence', selectedHandoff);
...
assert(selectedHandoff.designDecisionHandoff.canClaimDesignDecisionReady === false, 'handoff must not mark design decision ready before visual evidence', selectedHandoff);
...
assert(componentSource.includes('data-testid="workbench-eagle-candidate-visual-handoff"'), 'Eagle component should expose selected candidate handoff evidence');
