...
export const DESIGN_DOMAIN_CONCEPTS: DesignDomainConcept[] = [
    {
        ...
        typicalOutputs: ['可编辑主图 PSD 结构', '主图导出图片', '主图模板骨架'],
        ...
        relatedSkillIds: ['main-image-design', 'main-image-template-authoring'],
    ...
    },
    {
        ...
        typicalOutputs: ['可编辑详情页 PSD', '分屏导出图', '详情页模板骨架', '填充计划和 QA 报告'],
        ...
        relatedSkillIds: ['detail-page-design', 'detail-page-template-authoring'],
        maturity: 'partial-implementation'
    },
    {
        id: 'sku',
    ...
    },
    {
        ...
        relatedSkillIds: ['save-current-template', 'main-image-template-authoring', 'detail-page-template-authoring'],
        maturity: 'partial-implementation'
    },
    {
        id: 'recipe',
