...
import { readRuntimeActionProviderHandoff } from './agent-runtime-v5/runtime-action-provider-handoff';
...
export function buildAgentOperationDocumentTimeline(
    ...
    for (let index = 0; index < operations.length; index += 1) {
        ...
        const providerHandoff = readRuntimeActionProviderHandoff(operation.result);
