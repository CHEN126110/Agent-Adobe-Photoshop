...
const CLICK_IMAGE = [
    ...
    '素材角色没有全局优先级：真人穿着 / 使用场景可以提供动作、光影与代入感，平铺、细节或包装可以提供形态、比较与事实证据；哪一种承担主视觉、辅助位或不使用，必须由当前商品、点击目标和真实像素比较决定。历史样本结论、候选顺序和文件分辨率不能把“场景主图 + 平铺辅助”固化为默认答案；带吊牌、未整理的原始素材也不能未经观察直接当主视觉。',
