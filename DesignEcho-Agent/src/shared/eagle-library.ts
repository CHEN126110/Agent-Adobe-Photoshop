...
export interface EagleLibraryPagePreviewRequest {
    libraryPath: string;
    libraryId?: never;
    itemId: string;
    maxSize?: number;
...
export interface EagleComposerPreviewRequest {
    libraryId: string;
    libraryPath?: never;
    itemId: string;
    maxSize?: number;
...
export type EagleLibraryPreviewRequest =
    | EagleLibraryPagePreviewRequest
    | EagleComposerPreviewRequest;
