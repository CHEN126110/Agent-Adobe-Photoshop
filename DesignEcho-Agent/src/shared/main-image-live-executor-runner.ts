...
function makeResult(input: {
    ...
    const evidence: EvidenceRef[] = [{
        source: 'main-image-live-executor-runner',
        summary: `status=${input.status}; executed=${operationResults.length}; failedOperations=${failedOperationCount}; failedReadback=${failedReadbackCount}`,
