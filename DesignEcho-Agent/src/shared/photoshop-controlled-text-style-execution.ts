...
export interface ControlledPhotoshopTextStylePlanEvidence {
...
export interface ControlledPhotoshopTextStyleToolCallPlan {
    ...
    sourcePlanVersion: ControlledPhotoshopTextStylePlanEvidence['version'];
...
function makeEfficiencyEstimate(operationCount: number): ControlledPhotoshopTextStylePlanEvidence['efficiencyEstimate'] {
...
function makePlanEvidence(input: {
    ...
    blockers?: string[];
    warnings?: string[];
}): ControlledPhotoshopTextStylePlanEvidence {
...
function makeBenchmarkReport(input: {
    ...
    return {
        ...
        warnings: [
            'benchmark is estimate/sample evidence only; it must not be used as a typography quality claim',
...
export function buildControlledPhotoshopTextStyleToolCallPlan(
    ...
    return makeToolCallPlan({
        ...
        warnings: [
            ...plan.warnings,
            'tool-call plan is still no-write evidence; live execution requires explicit approval'
        ]
    });
}
