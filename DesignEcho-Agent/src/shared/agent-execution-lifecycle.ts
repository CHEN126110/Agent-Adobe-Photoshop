...
export function buildAgentExecutionLifecycleSnapshot(
    ...
    return {
        ...
        blockers,
        warnings,
        requiredNextEvidence: buildRequiredNextEvidence(phase, lifecycle, blockers),
        limitations: [
...
export function isAgentExecutionLifecycleBoundaryOk(
    ...
    return snapshot.evidenceOnly === true
...
function buildActor(
    ...
    lifecycle: AgentRequestLifecycleEvidence | undefined,
    activeToolName: string,
    phase: AgentExecutionLifecyclePhase
