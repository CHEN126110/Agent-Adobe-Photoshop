...
export interface ControlledPhotoshopExportPlanEvidence {
...
export interface ControlledPhotoshopExportToolCallPlan {
    ...
    sourcePlanVersion: ControlledPhotoshopExportPlanEvidence['version'];
...
function makeEstimate(operationCount: number): ControlledPhotoshopExportPlanEvidence['efficiencyEstimate'] {
    return {
...
function makePlanEvidence(input: {
    ...
    blockers?: string[];
    warnings?: string[];
}): ControlledPhotoshopExportPlanEvidence {
...
function makeToolCallPlan(input: {
    plan: ControlledPhotoshopExportPlanEvidence;
    status: ControlledPhotoshopExportToolCallPlanStatus;
    toolCalls?: ControlledPhotoshopExportToolCall[];
    blockers?: string[];
    warnings?: string[];
...
export function buildControlledPhotoshopExportBenchmarkReport(
    ...
    return {
        ...
        warnings: [
            'benchmark is estimate/sample evidence only; it must not be used as an export quality claim',
