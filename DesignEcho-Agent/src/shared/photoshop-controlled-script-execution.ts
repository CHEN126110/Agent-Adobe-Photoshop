...
export interface ControlledPhotoshopScriptToolCallPlan {
    ...
    sourcePlanVersion: ControlledPhotoshopScriptPlanEvidence['version'];
...
export interface ControlledPhotoshopScriptPlanEvidence {
...
function makeEvidence(input: {
    ...
    blockers?: string[];
    warnings?: string[];
}): ControlledPhotoshopScriptPlanEvidence {
...
function makeToolCallPlan(input: {
    plan: ControlledPhotoshopScriptPlanEvidence;
    status: ControlledPhotoshopScriptToolCallPlanStatus;
    toolCalls?: ControlledPhotoshopScriptToolCall[];
    blockers?: string[];
    warnings?: string[];
...
export function buildControlledPhotoshopLayerLightnessSortPlan(
    ...
    return makeEvidence({
        ...
        warnings: [
            ...
            'this only sorts by solid color or explicitly supplied lightness evidence; it does not understand visual hierarchy, group semantics or design quality'
        ]
    });
}
