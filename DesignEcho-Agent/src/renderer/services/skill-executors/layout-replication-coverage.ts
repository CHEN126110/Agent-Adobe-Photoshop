...
export interface ReferenceElementCoverageEvidence {
    expected: number;
    applied: number;
    failed: number;
    skipped: number;
...
export function buildTemplateApplyCoverageEvidence(params: {
    ...
    failedOps?: number;
}): ReferenceElementCoverageEvidence {
...
export function buildLayoutMatchCoverageEvidence(params: {
