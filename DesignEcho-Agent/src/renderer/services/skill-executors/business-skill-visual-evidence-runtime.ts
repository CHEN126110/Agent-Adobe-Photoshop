export interface BusinessSkillVisualEvidenceRefreshRuntimeCapabilities {
    canAnalyze: boolean;
    canWriteCache: boolean;
}

export function detectBusinessSkillVisualEvidenceRefreshRuntime(): BusinessSkillVisualEvidenceRefreshRuntimeCapabilities {
