        ...
        <div className="asset-gallery" data-testid="asset-gallery">
            ...
            <div className="gallery-content">
                ...
                <div className="image-panel">
                    ...
                    {selectedFolderInfo && (
                        <div className="asset-evidence-toolbar" data-testid="asset-gallery-role-filters">
