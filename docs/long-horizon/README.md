...
- `C:\UXP\2.0\DesignEcho-Agent`
- `C:\UXP\2.0\DesignEcho-UXP`

It should remain aligned with these existing architecture docs:

- `C:\UXP\2.0\DesignEcho-Agent\docs\agent-architecture-system-review.md`
- `C:\UXP\2.0\DesignEcho-Agent\docs\design-agent-execution-plan.md`
- `C:\UXP\2.0\DesignEcho-Agent\docs\skill-mcp-boundary-review.md`
